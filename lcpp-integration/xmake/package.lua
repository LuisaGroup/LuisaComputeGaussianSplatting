-- LuisaCompute Package Definition for xrepo
-- This package downloads and builds LuisaCompute from GitHub

package("luisa-compute")
    set_homepage("https://github.com/LuisaGroup/LuisaCompute")
    ...
    add_deps("lmdb", "reproc", "xxhash", "yyjson", "magic_enum", "marl", "stb")
